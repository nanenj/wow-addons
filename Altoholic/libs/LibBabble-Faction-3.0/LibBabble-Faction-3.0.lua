...
elseif GAME_LOCALE == "zhCN" then
	lib:SetCurrentTranslations {
	Acquaintance = "认识的人", -- Needs review
	Alliance = "联盟",
...
elseif GAME_LOCALE == "zhTW" then
	lib:SetCurrentTranslations {
	Acquaintance = "認識的人", -- Needs review
	Alliance = "聯盟",
