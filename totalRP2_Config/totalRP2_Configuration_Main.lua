	...
	{ -- Page General
		...
		["Composants"] = {
			...
			{ -- Police aide
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderAideTailleTexte:SetText(tostring(self:GetValue()));
					if self:IsVisible() then
		...
		["Composants"] = {
			...
			{ -- Alpha raccbar
				...
				["OnChange"] = function(self)
					...
					TRP2ConfigSliderAlpharaccbarTexte:SetText(self:GetValue().."%");
				end;
				["SliderMin"] = 0;
				["SliderMax"] = 100;
				["Width"] = 150;
	...
	{ -- Page ChatFrame
		...
		["Composants"] = {
			...
			{ -- HRP Mode
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderHRPModeTexte:SetText(TRP2_CTS(TRP2_LOC_HRPMODETab[self:GetValue()]));
			...
			{ -- Emote Mode
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderEmoteModeTexte:SetText(TRP2_CTS(TRP2_LOC_EMOTEMODETab[self:GetValue()]));
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 3;
				["Width"] = 150;
			...
			{ -- PNJ Mode
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderPNJModeTexte:SetText(TRP2_CTS(TRP2_LOC_PNJMODETab[self:GetValue()]));
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 2;
				["Width"] = 150;
	...
	{ -- Page Tooltips
		...
		["Composants"] = {
			...
			{ -- Anchor point
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderTTPersoAnchorPointTexte:SetText(TRP2_LOC_AnchorTab[self:GetValue()]);
					if self:IsVisible() then
						TRP2_MouseOverTooltip("player");
					end
				end;
			...
			{ -- Anchor point
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderTTMountAnchorPointTexte:SetText(TRP2_LOC_AnchorTab[self:GetValue()]);
					if self:IsVisible() then
						TRP2_MouseOverTooltip("player");
					end
				end;
			...
			{ -- Taille titre
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderTTPersoTailleTitreTexte:SetText(self:GetValue());
					if self:IsVisible() then
						TRP2_MouseOverTooltip("player");
					end
				end;
			...
			{ -- Taille info
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderTTPersoTailleInfoTexte:SetText(self:GetValue());
					if self:IsVisible() then
						TRP2_MouseOverTooltip("player");
					end
				end;
			...
			{ -- Taille descri
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderTTPersoTailleDescriTexte:SetText(self:GetValue());
					if self:IsVisible() then
						TRP2_MouseOverTooltip("player");
					end
				end;
			...
			{ -- Couper Descri
				...
				["OnChange"] = function(self)
					...
					if self:GetValue() ~= 0 then 
						TRP2ConfigSliderCouperDescriTexte:SetText(TRP2_FT(TRP2_LOC_PAR_CutAfterX,tostring(self:GetValue())));
					else
			...
			{ -- Couper Notes
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					if self:GetValue() ~= 0 then 
						TRP2ConfigSliderCouperNotesTexte:SetText(TRP2_FT(TRP2_LOC_PAR_CutAfterX,tostring(self:GetValue())));
					else
	...
	{ -- Page Security
		...
		["Composants"] = {
			{ -- Access defaut
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderAccessDefautTexte:SetText(TRP2_CTS(TRP2_LOC_AccessTab[self:GetValue()]));
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 4;
				["Width"] = 150;
			...
			{ -- Access Hist
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					_G[self:GetName().."Texte"]:SetText(TRP2_CTS(TRP2_LOC_AccessTab[self:GetValue()]));
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 4;
				["Width"] = 150;
			...
			{ -- Access Son globaux
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderSonsglobauxAccesTexte:SetText(TRP2_LOC_AccessTab[self:GetValue()]);
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 4;
				["Width"] = 150;
			...
			{ -- Access paroles scripts
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderParolesAccesTexte:SetText(TRP2_LOC_AccessTab[self:GetValue()]);
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 4;
				["Width"] = 150;
			...
			{ -- Access LUA scripts
				...
				["OnChange"] = function(self)
					TRP2_Module_Configuration[TRP2_Royaume][TRP2_Joueur][self.VarName] = self:GetValue();
					TRP2ConfigSliderScriptsAccesTexte:SetText(TRP2_LOC_AccessTab[self:GetValue()]);
				end;
				["SliderMin"] = 1;
				["SliderMax"] = 4;
				["Width"] = 150;
