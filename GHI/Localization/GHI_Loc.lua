...
function GHI_Loc()
	...
	local textsOptionsAppearance = {
     ...
     local textsBookUI = {
          ...
          EDIT_TITLE = {
               enUS = "Edit Title",
               deDE = "Titel editieren",
               frFR = "Éditer le titre",
          },
		 TITLE = {
               enUS = "Book Title:",
               deDE = "Titel:",
    ...
    local textsSimpleItemMenu = {
		...
		SM_SELECT = {
			enUS = "Please select an action for your item.",
		},
		SM_BAG_SET = {
	...
	meta.__index = function(self,key)
		...
		local texts = textsContainer[key] or textsOptionsMain[key] or textsOptionsBag[key] or textsOptionsAppearance[key] or textsDynamicActionArea[key]
				  ...
				  or textsEquipmentDisplay[key] or textsViewAttributeMenu[key] or textsSoundConfirm[key];
		if not(texts) then
