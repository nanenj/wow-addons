...
function GHI_DynamicAction(dataTable)
	...
	local gotOnSetupPort, portsOrderIn, portsOrderOut, allPortsTriggerScript;
	...
	class.GenerateActionInstance = function()
		return GHI_DynamicActionInstance(guid);
	end
	...
	local GenerateMenu = function(parent)
		local menuPageData = {};
		local menuFrame;
	...
	class.GetFreeMenu = function(parent)
		for _, menu in pairs(menus) do
			if not (menu.inUse == true) then
				return menu;
			end
		end
		return GenerateMenu(parent);
	end
