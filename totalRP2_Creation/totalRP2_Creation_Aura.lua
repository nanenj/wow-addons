...
function TRP2_ChargerCreaAuraPanel(AuraID)
	...
	TRP2_CreationFrameAuraFrameGeneralType:SetValue(TRP2_GetWithDefaut(AuraTab,"Type",2));
	...
	TRP2_CreationFrameAuraFrameGeneralCategorie:SetValue(tonumber(TRP2_GetWithDefaut(AuraTab,"EtatCat",2)));
...
function TRP2_SetAuraApercuTooltip(bouton,ID)
	...
	local Titre;
	local Message = "{v}< "..TRP2_Auras_Categorie[tonumber(TRP2_GetWithDefaut(objet,"EtatCat",2))].." >\n";
	...
	Titre = TRP2_Auras_Color[TRP2_GetWithDefaut(objet,"Type",2)].."|TInterface\\ICONS\\"..TRP2_GetWithDefaut(objet,"Icone","Temp")..":30:30|t "..TRP2_GetWithDefaut(objet,"Nom",TRP2_LOC_NewAura);
...
function TRP2_CreateAuraTabCreation()
	...
	objet["EtatCat"] = TRP2_DefautToNil(TRP2_CreationFrameAuraFrameGeneralCategorie:GetValue(),2);
