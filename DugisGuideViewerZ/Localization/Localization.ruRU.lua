...
--	["Map each destination with TomTom"] = "составить карту к каждой цели с помощью TomTom",
	...
	["No Guide Loaded. Right Click Here To Select One"] = "Путеводитель не выбран. Нажмите сюда правой кнопкой мыши для выбора Путеводителя",
	["Note"] = "Примечание",
...
--	["Show On/Off Button = "Отобразить кнопку Вкл./Выкл.",
