...
function TRP2_TraiterTooltipPerso(Nom,infoTab,j,TT_Type)
	...
	if persoTab then
		...
		local texteADroite = "";
		local nomTotal = TRP2_ColorToHexa(C.r,C.g,C.b)..TRP2_nomComplet(Nom,TRP2_GetConfigValueFor("TTPersoCompoTitre",false));
...
function TRP2_TraiterTooltipPet(NomMaitre,Nom,infoTab,j,TT_Type)
...
function TRP2_DD_PotraitIconeClick(frame,level,menuList)
	...
	if not nom then nom = UnitName("target"); end
