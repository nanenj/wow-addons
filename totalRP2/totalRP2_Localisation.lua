...
function TRP2_LocalisationLanguages()
	...
	TRP2_DB_Languages["Taurahe"]["Description"] = "The dialect spoken by the Taurens.";
...
function TRP2_LocalisationGerman()
	...
	TRP2_LOC_ACCUEIL = "{v}Total RP 2 Build {o}"..TRP2_version.."\n{c}Danke, dass du dich für TRP2 entschieden hast. Viel Spass ;)\n";
	TRP2_LOC_GPS = "{j}"..LOCATION_COLON.."\n"..CONTINENT.." : %1\n"..ZONE_COLON.." %2\nSubzone: %3\nX: %4  , Y: %5";
